<template>
  <div style="width: 85%; margin: 10px auto" class="card">
    ...
    <el-dialog title="订单信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" :modal="false" :append-to-body="true" destroy-on-close>
...
export default {
  ...
  methods: {
    pay(orderNo) {
      window.open('http://8.140.237.76:9090/alipay/pay?orderNo=' + orderNo)
    },
